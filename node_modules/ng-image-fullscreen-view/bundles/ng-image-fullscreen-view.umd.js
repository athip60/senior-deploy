(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ng-image-fullscreen-view', ['@angular/core','@angular/platform-browser','@angular/common','exports', '@angular/core', '@angular/common', '@angular/platform-browser'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.platformBrowser,global.ng.common,global['ng-image-fullscreen-view'] = {}, global.ng.core, global.ng.common, global.ng.platformBrowser));
...
function NgImageFullscreenViewComponent_div_0_div_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(9, _c2, ctx_r3.popupWidth + "px"));
    ɵngcc0.ɵɵattribute("id", "ng-lightbox-image-" + i_r8);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("imageUrl", img_r7.image || img_r7.video)("isVideo", !!(img_r7.posterImage || img_r7.video))("videoAutoPlay", ctx_r3.videoAutoPlay)("showVideoControls", ctx_r3.showVideoControls ? 1 : 0)("alt", img_r7.alt || img_r7.title || "")("title", img_r7.title || img_r7.alt || "")("direction", ctx_r3.direction);
} }
...
function NgImageFullscreenViewComponent_div_0_a_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NgImageFullscreenViewComponent_div_0_a_10_Template_a_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r14); var ctx_r13 = ɵngcc0.ɵɵnextContext(2); return ctx_r13.prevImageLightbox(); });
    ɵngcc0.ɵɵtext(1, "\u2039");
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function NgImageFullscreenViewComponent_div_0_a_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NgImageFullscreenViewComponent_div_0_a_11_Template_a_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r16); var ctx_r15 = ɵngcc0.ɵɵnextContext(2); return ctx_r15.nextImageLightbox(); });
    ɵngcc0.ɵɵtext(1, "\u203A");
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function NgImageFullscreenViewComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NgImageFullscreenViewComponent_div_0_Template_a_click_2_listener() { ɵngcc0.ɵɵrestoreView(_r18); var ctx_r17 = ɵngcc0.ɵɵnextContext(); return ctx_r17.closeLightbox(); });
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵtemplate(7, NgImageFullscreenViewComponent_div_0_div_7_Template, 3, 11, "div", 8);
    ɵngcc0.ɵɵelementEnd();
...
'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgImageFullscreenViewService = /** @class */ (function () {
        ...
        NgImageFullscreenViewService.prototype.isBase64 = function (str) {
            var base64regex = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/;
            return base64regex.test(str);
        };
        NgImageFullscreenViewService.prototype.base64FileExtension = function (str) {
            return str.substring('data:image/'.length, str.indexOf(';base64'));
        };
        NgImageFullscreenViewService.ɵprov = core.ɵɵdefineInjectable({ factory: function NgImageFullscreenViewService_Factory() { return new NgImageFullscreenViewService(); }, token: NgImageFullscreenViewService, providedIn: "root" });
        NgImageFullscreenViewService = __decorate([ __metadata("design:paramtypes", [])
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgImageFullscreenViewService, [{
    ...
    var LIGHTBOX_NEXT_ARROW_CLICK_MESSAGE = 'lightbox next', LIGHTBOX_PREV_ARROW_CLICK_MESSAGE = 'lightbox previous';
    var NgImageFullscreenViewComponent = /** @class */ (function () {
        ...
        Object.defineProperty(NgImageFullscreenViewComponent.prototype, "imageIndex", {
            set: function (index) {
        ...
        Object.defineProperty(NgImageFullscreenViewComponent.prototype, "show", {
            set: function (visiableFlag) {
        ...
        Object.defineProperty(NgImageFullscreenViewComponent.prototype, "animationSpeed", {
            set: function (data) {
                if (data
                    && typeof (data) === 'number'
                    && data >= 0.1
        ...
        NgImageFullscreenViewComponent.prototype.onResize = function (event) {
            this.effectStyle = 'none';
            this.setPopupSliderWidth();
        };
        NgImageFullscreenViewComponent.prototype.handleKeyboardEvent = function (event) {
        ...
        NgImageFullscreenViewComponent.prototype.ngOnDestroy = function () {
            this.resetState();
        };
        NgImageFullscreenViewComponent.prototype.setPopupSliderWidth = function () {
            var _this = this;
        ...
        NgImageFullscreenViewComponent.prototype.closeLightbox = function () {
            this.close.emit();
        };
        NgImageFullscreenViewComponent.prototype.prevImageLightbox = function () {
        ...
        NgImageFullscreenViewComponent.prototype.nextImageLightbox = function () {
            this.effectStyle = "all " + this.speed + "s ease-in-out";
        ...
        NgImageFullscreenViewComponent.prototype.nextPrevDisable = function () {
            var _this = this;
        ...
        NgImageFullscreenViewComponent.prototype.applyButtonDisableCondition = function () {
            this.lightboxNextDisable = false;
            this.lightboxPrevDisable = false;
        ...
        NgImageFullscreenViewComponent.prototype.getImageData = function () {
            if (this.images
                && this.images.length
        ...
        NgImageFullscreenViewComponent.prototype.resetState = function () {
            this.images = [];
        };
        /**
         * Swipe event handler
         ...
         */
        NgImageFullscreenViewComponent.prototype.swipeLightboxImg = function (e, when) {
        ...
        NgImageFullscreenViewComponent.ctorParameters = function () { return [
        ...
        NgImageFullscreenViewComponent = __decorate([ __param(4, core.Inject(common.DOCUMENT)),
            __metadata("design:paramtypes", [core.ChangeDetectorRef,
                platformBrowser.DomSanitizer,
                core.ElementRef,
                NgImageFullscreenViewService, Object])
        ], NgImageFullscreenViewComponent);
NgImageFullscreenViewComponent.ɵfac = function NgImageFullscreenViewComponent_Factory(t) { return new (t || NgImageFullscreenViewComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.DomSanitizer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(NgImageFullscreenViewService), ɵngcc0.ɵɵdirectiveInject(common.DOCUMENT)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgImageFullscreenViewComponent, [{
    ...
    var SliderCustomImageComponent = /** @class */ (function () {
        ...
        SliderCustomImageComponent = __decorate([ __metadata("design:paramtypes", [NgImageFullscreenViewService, platformBrowser.DomSanitizer])
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SliderCustomImageComponent, [{
    ...
    }], function () { return [{ type: NgImageFullscreenViewService }, { type: ɵngcc1.DomSanitizer }]; }, { videoAutoPlay: [{
            type: core.Input
        }], showVideoControls: [{
            type: core.Input
        }], isVideo: [{
    ...
    var NgImageFullscreenViewModule = /** @class */ (function () {
        function NgImageFullscreenViewModule() {
        }
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgImageFullscreenViewModule, { declarations: [SliderCustomImageComponent, NgImageFullscreenViewComponent], imports: [ɵngcc2.CommonModule], exports: [NgImageFullscreenViewComponent] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgImageFullscreenViewModule, [{
    ...
    exports.NgImageFullscreenViewComponent = NgImageFullscreenViewComponent;
    exports.NgImageFullscreenViewModule = NgImageFullscreenViewModule;
    exports.NgImageFullscreenViewService = NgImageFullscreenViewService;
...
//# sourceMappingURL=ng-image-fullscreen-view.umd.js.map